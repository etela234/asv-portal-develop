...
<form method="post" action="processSignatureUpload.jsp" enctype="multipart/form-data">
		...
		<td>
			<table class="bordered_table" cellpadding="0" cellspacing="1" width="90%">
				...
				<tr class="white_bg">
					...
					<td class="norm_login_text_cell"><input type="text" name="FIRST_NAME" id="FIRST_NAME" class="norm_login_text" required size="40" maxlength="50" /></td>
				</tr>
				<tr class="white_bg">
					<td class="norm_login_text_cell_bold" height="40">Middle Name:</td>
					<td class="norm_login_text_cell"><input type="text" name="MIDDLE_NAME" id="MIDDLE_NAME" class="norm_login_text" size="40" maxlength="50" /></td>
				</tr>
				<tr class="white_bg">
					<td class="norm_login_text_cell_bold" height="40">Last Name:</td>
					<td class="norm_login_text_cell"><input type="text" name="LAST_NAME" id="LAST_NAME" class="norm_login_text" required size="40" maxlength="50" /></td>
				</tr>
				<tr class="white_bg">
					<td class="norm_login_text_cell_bold" height="40">Designation:</td>
					<td class="norm_login_text_cell">
					<input type="text" name="DESIGNATION" id="DESIGNATION" class="norm_login_text" required size="40" maxlength="50" />
				...
				<tr class="white_bg">
					...
					<td class="norm_login_text_cell"><input type="text" name="CATEGORY_NUM" id="CATEGORY_NUM" class="norm_login_text" required size="40" maxlength="20" /></td>
				</tr>
				<tr class="white_bg">
					<td class="norm_login_text_cell_bold" height="40">Staff ID:</td>
					<td class="norm_login_text_cell"><input type="text" name="SERIAL_NUM" id="SERIAL_NUM" class="norm_login_text" required size="40" maxlength="20" /></td>
				</tr>
				<tr class="white_bg">
