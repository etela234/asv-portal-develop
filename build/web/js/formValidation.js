$(document).ready(function() {
	...
	$("#NIBSS_EDIT_USER").validate({
		...
		submitHandler: function(form) { 
			...
			var phone_num = $("input#PHONE_NUM").val();
			//var dataString = 'USER_ID='+user_id+'&FIRST_NAME='+first_name+'&LAST_NAME='+last_name+'&EMAIL='+email+'&PASSWORD='+password+'&GENDER='+gender+'&PHONE_NUM='+phone_num+'&COMPANY_NAME='+company+'&COMPANY_ADDRESS='+company_add+'&USER_TYPE_NAME='+user_type_name+'&action=3';
			var dataString = 'ITEM_ID='+item_id+'&USER_ID='+user_id+'&FIRST_NAME='+first_name+'&LAST_NAME='+last_name+'&EMAIL='+email+'&GENDER='+gender+'&PHONE_NUM='+phone_num+'&COMPANY_NAME='+company+'&COMPANY_ADDRESS='+company_add+'&USER_TYPE_NAME='+user_type_name+'&action=3b';
			$.ajax({   
			  type: "POST",   
			  url: "processRequests.jsp",   
			  data: dataString,  
			  ...
			  success: function(response) {   
				if (response ==0){	 //Registration
					$('#create_user_message').html("<div id='message' class='success'></div>"); 
					$('#message').append("<img src='images/tick.png'/> User has been modified successfully!!!<br/>")
					$('#message').hide()   
					$('#message').fadeIn(500, function() {   
					  $('#message').append(""); 
					}); 
					...
					$('#create_user_message').html("<div id='message' class='success'></div>"); 
					$('#message').append("<img src='images/cancel.png'/> User does not exist, try again!!!<br/>")
					$('#message').hide()   
					$('#message').fadeIn(500, function() {   
					  $('#message').append("");
					}); 
	...
	$("#EDIT_USER").validate({
		...
		submitHandler: function(form) { 
			...
			var phone_num = $("input#PHONE_NUM").val();
			//var dataString = 'USER_ID='+user_id+'&FIRST_NAME='+first_name+'&LAST_NAME='+last_name+'&EMAIL='+email+'&PASSWORD='+password+'&GENDER='+gender+'&PHONE_NUM='+phone_num+'&COMPANY_NAME='+company+'&COMPANY_ADDRESS='+company_add+'&USER_TYPE_NAME='+user_type_name+'&action=3';
			var dataString = 'ITEM_ID='+item_id+'&USER_ID='+user_id+'&FIRST_NAME='+first_name+'&LAST_NAME='+last_name+'&EMAIL='+email+'&GENDER='+gender+'&PHONE_NUM='+phone_num+'&COMPANY_NAME='+company+'&COMPANY_ADDRESS='+company_add+'&USER_TYPE_NAME='+user_type_name+'&action=3c';
			$.ajax({   
			  type: "POST",   
			  url: "processRequests.jsp",   
			  data: dataString,  
