...
<p class="subInfo underlay">Create New Main Menu&raquo;&raquo;</p>	
<form id="CREATE_MAIN_MENU" method="post">
<input type="hidden" name="USER_ID" id="USER_ID" value="<%=USER_ID%>"/>
<div id='main_menu_response' align="center"></div>	
<table class="bordered_table" cellpadding="0" cellspacing="1" width="60%" align="center">
	...
	<tr class="white_bg">
		...
		<td class="norm_login_text_cell">
			<input type="text" name="MAIN_MENU_NAME" id="MAIN_MENU_NAME" class="norm_text" size="40"  required />
		</td>
	</tr>
	<tr class="white_bg">
		<td height="40" class="norm_login_text_cell_bold">Main Menu URL:</td>
		<td class="norm_login_text_cell">
			<input type="text" name="MAIN_MENU_URL" id="MAIN_MENU_URL" class="norm_text" size="40"  required />
		</td>
	</tr>
	<tr class="white_bg">
