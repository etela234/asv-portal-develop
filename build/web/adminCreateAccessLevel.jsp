...
String html_company_cat = util.getHtmlOptionBankCategory(BANK_NAME);
%>
<!-- InstanceEndEditable -->
...
<form method="POST">
<table class="bordered_table" cellpadding="0" cellspacing="1" align="center">
	<tr>
		<td class="title-bkg" colspan="2"> Creating Access Level</td>
	</tr>
	<tr class="white_bg">
		<td class="norm_login_text_cell_bold" height="40">Institution:</td>
		<td class="norm_login_text_cell">
			<select name="BANK_NAME" id="BANK_NAME" size="1" class="norm_text" onchange="this.form.submit()" required>
				  <%=html_company%>
			</select>	
		</td>
	</tr>
	<tr class="white_bg">
		<td class="norm_login_text_cell" height="40"><strong>Access Level:</strong><br /><span class="norm_text">Note: you can select multiple accesses</span></td>
		<td class="norm_login_text_cell">
		<select name="BANK_CATEGORY" id="BANK_CATEGORY"  size="10"  class="norm_text" multiple required>
			  <%=html_company_cat%>
		</select>
			</td>
	</tr>
