...
<p><span class="subInfo underlay">Create New User Type&raquo;&raquo;</span>	</p>
<form id="CREATE_USER_TYPE" method="post">
<input type="hidden" name="USER_ID" id="USER_ID" value="<%=USER_ID%>"/>
<div id='user_type_response' align="center"></div>	
<table class="bordered_table" cellpadding="0" cellspacing="1" width="60%" align="center">
	...
	<tr class="white_bg">
		...
		<td class="norm_login_text_cell">
			<input type="text" name="USER_TYPE_NAME" id="USER_TYPE_NAME" class="norm_text" size="40"  required />
		</td>
	</tr>
	...
	<tr class="white_bg">
		<td colspan="2" height="40" align="center"><input type="submit" id="loginbtn" value="Submit" /></td>
	</tr>	
</table>	  		  
 </form>		  
