...
try{
	rowcount = util.getRecordListUsers(searchBy, searchFor, USER_ID);
}catch(Exception e){
	e.printStackTrace();
}
...
<table width="900" align="center">
	<tr>
		<td valign="top">| <a href="bankCreateUser.jsp" class="norm_login_text">Create User Login</a> |</td>  
	</tr>
</table>
...
<table width="900" align="center" class="bordered_table" cellpadding="0" cellspacing="1">
	...
	<%
	try{
		resultConStmt = util.listAllUsers(searchBy, searchFor, USER_ID);
	...
	<tr class="white_bg_row">
		...
		<td class="norm_text" height="30"><a href="bankEditUser.jsp?ID=<%=encryptedS%>"><%=rs.getString("FIRST_NAME")%></a></td>
