...
html_userType += util.getHtmlOptionUserType();
...
<form id="NIBSS_CREATE_USER" method="post">
...
<table class="bordered_table" cellpadding="0" cellspacing="1" width="70%" align="center">
	...
	<tr class="white_bg">
		...
		<td class="norm_login_text_cell"><input type="text" name="EMAIL" id="EMAIL" class="norm_login_text" required size="40" maxlength="100" /></td>
	</tr>
	<!--tr class="white_bg">
	...
	<tr class="white_bg">
		...
		<td class="norm_login_text_cell"><input type="text" name="PHONE_NUM" id="PHONE_NUM" class="norm_login_text" required size="40" maxlength="20" /></td>
	</tr>
	<tr class="white_bg">
	...
	<tr class="white_bg">
		...
		<td class="norm_login_text_cell"><textarea name="COMPANY_ADDRESS" id="COMPANY_ADDRESS" class="norm_login_text" required cols="30" rows="5"></textarea></td>
	</tr>
