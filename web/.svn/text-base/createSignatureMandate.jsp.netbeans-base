...
String html_salutation = "<option value=''>«»«»Select Salutation«»«»</option>";
html_salutation += util.getHtmlOptionSalutation(SALUTATION);

String html_comp_close = "<option value=''>«»«»Select Complimentary«»«»</option>";
html_comp_close += util.getHtmlOptionComplimentary(COMPLIMENTARY_CLOSE);

String auth_signatory = "<option value=''>«»«»Select A Signatory«»«»</option>";
...
<p class="subInfo underlay">Create Bank Signature Mandate &raquo;&raquo; &nbsp;</p>
<form method="post" action="processSignatureMandate.jsp" >
<table align="center">
	<tr>
		<td>
			<table class="bordered_table" cellpadding="0" cellspacing="1">
				...
				<tr class="white_bg">
					...
					<td class="norm_login_text_cell"><textarea type="text" name="MESSAGE" id="MESSAGE" class="norm_login_text" required cols="60" rows="10"></textarea></td>
				</tr>
				<tr class="white_bg">
