...
String DESIGNATION="", CATEGORY_CODE="", CATEGORY_NUM="";
String SERIAL_NUM="";
...
try{
	...
	if(rs.next()){
		...
		CATEGORY_NUM = rs.getString("CATEGORY_NO");
...
String html_designation = "<option value=''>«»«»Select Designation«»«»</option>";
html_designation += util.getHtmlOptionDesignation(DESIGNATION);
...
<p class="subInfo underlay">Single Bank Signatory Creation &raquo;&raquo; &nbsp;</p>
<form method="post" action="processEditSignatureUpload.jsp" enctype="multipart/form-data">
		...
		<td>
			<table class="bordered_table" cellpadding="0" cellspacing="1" width="90%">
				...
				<tr class="white_bg">
					...
					<td class="norm_login_text_cell"><input type="text" name="MIDDLE_NAME" id="MIDDLE_NAME" value="<%=MIDDLE_NAME%>" class="norm_login_text" size="40" maxlength="50" /></td>
				</tr>
				<tr class="white_bg">
				...
				<tr class="white_bg">
					...
					<input type="text" name="DESIGNATION" id="DESIGNATION" value="<%=DESIGNATION%>" class="norm_login_text" required size="40" maxlength="50" />
					<!--select name="DESIGNATION" id="DESIGNATION" size="1" class="norm_text" required>
						  <!--%=html_designation%>
					</select-->
					</td>
				</tr>
				<tr class="white_bg">
					...
					<td class="norm_login_text_cell">
					<select name="CATEGORY_CODE" class="norm_text" required>
						<option value="" <%=CATEGORY_CODE.equals("") ? "selected":""%>>Select Category</option>
						<option value="A" <%=CATEGORY_CODE.equals("A") ? "selected":""%>>Category A</option>
						<option value="B" <%=CATEGORY_CODE.equals("B") ? "selected":""%>>Category B</option>
						<option value="C" <%=CATEGORY_CODE.equals("C") ? "selected":""%>>Category C</option>
					</select>
					</td>
				</tr>
				<tr class="white_bg">
					<td class="norm_login_text_cell_bold" height="40">Signature Code:</td>
					<td class="norm_login_text_cell"><input type="text" name="CATEGORY_NUM" id="CATEGORY_NUM" value="<%=CATEGORY_NUM%>" class="norm_login_text" required size="40" maxlength="20" /></td>
				</tr>
				<tr class="white_bg">
					<td class="norm_login_text_cell_bold" height="40">Staff ID:</td>
					<td class="norm_login_text_cell"><input type="text" name="SERIAL_NUM" id="SERIAL_NUM" value="<%=SERIAL_NUM%>" class="norm_login_text" required size="40" maxlength="20" /></td>
				</tr>
				<tr class="white_bg">
				...
				<tr class="white_bg">
					<td colspan="2" height="40" align="center"><input type="submit" name="uploadbtn" id="uploadbtn" value="Upload &raquo;&raquo;" /></td>
				</tr>
			</table>
		</td>
