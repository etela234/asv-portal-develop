...
try{
	boolean isMultipart = ServletFileUpload.isMultipartContent(request);
	 if (!isMultipart) {
		   ...
		   result = util.insertBulkUserProfile(USER_ID,USER_TYPE_NAME,absoluteDiskPath,newTextFile,request);
...
<table width="800" align="center" class="bordered_table" cellpadding="0" cellspacing="1">
	<tr>
		<td class="title-bkg" height="25" colspan="4">Bulk User(s) Upload Summary Report</td>
	</tr>
	<tr class="white_bg">
