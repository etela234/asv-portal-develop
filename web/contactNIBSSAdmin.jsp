...
<p class="subInfo underlay">Contact NIBSS Admin &raquo;&raquo;</p>		
<form method="post" id="CONTACT_NIBSS">
<input type="hidden" name="USER_ID" id="USER_ID" value="<%=USER_ID%>"/>
<table width="500px" align="center">
	<tr>
		<td><div id='save_message' align="center"></div></td>
	</tr>
</table>
<table cellpadding="0" cellspacing="1" class="bordered_table" width="500px" align="center">
	...
	<tr class="white_bg">
		<td class="norm_text" height="20" colspan="2"><span style="color:#FF0000">&nbsp;*Note: when you click on send, your request will be forwarded as a mail to NIBSS Admin</span></td>
	</tr>
	<tr class="white_bg">
		<td class="norm_login_text_cell_bold" height="40">
			Subject:
		</td>
		<td class="norm_login_text_cell_bold"><span class="error"></span><input name="SUBJECT" type="text" size="30" class="norm_text" id="SUBJECT"/></td>
	</tr>
	<tr class="white_bg">
		<td class="norm_login_text_cell_bold" height="80">
			Message:
		</td>
		<td class="norm_login_text_cell_bold"><span class="error"></span><textarea name="MESSAGE" class="norm_text" rows="5" cols="30" id="MESSAGE"></textarea></td>
	</tr>
	<tr class="white_bg">
		<td class="norm_login_text_cell_bold" height="40" colspan="2" align="center"><input type="submit" name="submit" id="submit" value="Send"/></td>
	</tr>
</table>
</form>		
