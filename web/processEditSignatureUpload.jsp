 ...
 if (!isMultipart) {
	   ...
	   while (itr.hasNext()) 
	   {
	   	...
	   	if (newFile.equals(CATEGORY_NUM.trim())){
			sc.setKey();
			ITEM_ID = sc.decrypt(ITEM_ID);
	   		result = util.updateSignatureUpload(ITEM_ID, USER_ID,strFileName,FIRST_NAME,MIDDLE_NAME,LAST_NAME, CATEGORY_CODE,CATEGORY_NUM, SERIAL_NUM, DESIGNATION, SIGNATORY_ID, request);
		}else{
			result = -1;
		}
