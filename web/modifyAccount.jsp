...
<p class="subInfo underlay">Change account password &raquo;&raquo;</p>		
<form method="post" id="CHANGE_PASSWORD">
<input name="USER_ID" id="USER_ID" type="hidden" value="<%=USER_ID%>"/>
<table width="500px" align="center">
	<tr>
		<td><div id='save_password' align="center"></div>
</td>
	</tr>
</table>
<table cellpadding="0" cellspacing="1" class="bordered_table" width="500px" align="center">
	<tr class="white_bg">
		<td class="title-bkg" colspan="2">Kindly fill the form below</td>
	</tr>
	<tr class="white_bg">
		<td class="norm_text" height="30" colspan="2"><span style="color:#FF0000">**You are advised to specify a password you can easily remember.<br />**Password must be alpha-numeric, contain an Upper-case character and must not be lesser than 8 characters long
		</span></td>
	</tr>
	<tr class="white_bg">
		...
		<td class="norm_login_text_cell_bold"><span class="error"></span><input name="OLD_PASSWORD" type="password" size="30" class="norm_text" id="OLD_PASSWORD"/></td>
	</tr>
	<tr class="white_bg">
		<td class="norm_login_text_cell_bold" height="40">
			New Password:
		</td>
		<td class="norm_login_text_cell_bold"><span class="error"></span><input name="NEW_PASSWORD" type="password" class="norm_text" size="30" id="NEW_PASSWORD"/></td>
	</tr>
	<tr class="white_bg">
		<td class="norm_login_text_cell_bold" height="40">
			Confirm New Password:
		</td>
		<td class="norm_login_text_cell_bold"><span class="error"></span><input name="C_NEW_PASSWORD" type="password" class="norm_text" size="30" id="C_NEW_PASSWORD"/></td>
	</tr>
	<tr class="white_bg">
		<td class="norm_login_text_cell_bold" height="40" colspan="2" align="center"><input type="submit" id="submit" value="Submit" /></td>
	</tr>
</table>
</form>				
