...
html_userType += util.getHtmlOptionAllUserType();

String html_mainMenu = "<option value=''>«»«»Select Main Menu«»«»</option>";
html_mainMenu += util.getHtmlOptionMainMenu();
...
<p class="subInfo underlay">Create New Sub Menu&raquo;&raquo;</p>	
<form id="CREATE_SUB_MENU" method="post">
<input type="hidden" name="USER_ID" id="USER_ID" value="<%=USER_ID%>"/>
<div id='sub_menu_response' align="center"></div>	
<table class="bordered_table" cellpadding="0" cellspacing="1" width="60%" align="center">
	<tr>
		<td class="title-bkg" colspan="2"> Please fill the form appropriately</td>
	</tr>
	<tr class="white_bg">
		<td height="40" class="norm_login_text_cell_bold">Main Menu Name:</td>
		<td class="norm_login_text_cell"><span class="error"></span>
			<select name="MAIN_MENU_NAME" id="MAIN_MENU_NAME" size="1" class="norm_text">
			  <%=html_mainMenu%>
			</select>
		</td>
	</tr>
	<tr class="white_bg">
		...
		<td class="norm_login_text_cell"><span class="error"></span>
			<select name="USER_TYPE_NAME" id="USER_TYPE_NAME" size="1" class="norm_text">
			  <%=html_userType%>
			</select>
		</td>
	</tr>
	<tr class="white_bg">
		<td height="40" class="norm_login_text_cell_bold">Sub Menu Name:</td>
		<td class="norm_login_text_cell">
			<input type="text" name="SUB_MENU_NAME" id="SUB_MENU_NAME" class="norm_text" size="40"  required />
		</td>
	</tr>
	<tr class="white_bg">
		<td height="40" class="norm_login_text_cell_bold">Sub Menu URL:</td>
		<td class="norm_login_text_cell">
			<input type="text" name="SUB_MENU_URL" id="SUB_MENU_URL" class="norm_text" size="40"  required />
		</td>
	</tr>
	<tr class="white_bg">
